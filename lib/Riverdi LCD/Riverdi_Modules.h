 ...
 */
...
#if defined (NTP_28) || defined (RTP_28) || defined (CTP_28)
  #define DispWidth      240
  #define DispHeight     320L
  #define DispHCycle     270L
  #define DispHOffset    20L
  #define DispHSync0     0L
  #define DispHSync1     10L
  #define DispVCycle     326L
  #define DispVOffset    2L
  ...
  #define DispDither     0
#elif defined (NTP_35) || defined (RTP_35) || defined (CTP_35)
